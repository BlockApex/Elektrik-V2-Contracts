...
| testCancelOrdersFail          | Tests order cancellation with failed fill            | ✔                   |
| testSingleOrder               | Tests single order execution with pre-interaction     | ✔                   |
| testFacilitatorSwap           | Tests facilitator swap functionality                 | ✔                   |